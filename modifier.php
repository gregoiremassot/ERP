 ...
 <div class ="tab-content ">
		...
		<div class="col-md-6 col-md-offset-3">
			<p>
				...
				<legend>Modifier une étude</legend >
				<div class ="tab-pane fade active in" id="Fiche"></div>
					...
					<strong> Date de début </strong> <input type="date" name="DebutDate" value="<?php if($donnes['DebutDate']>'0000-00-01')
												{ echo $donnes['DebutDate'];}
												?>"/>
					<br>
					 <strong> Date de fin </strong> <input type="date" name="FinDate" value="<?php if($donnes['FinDate']>'0000-00-01')
												{ echo $donnes['FinDate'];}
												?>"/>
					<br>
...
<input type="radio" name="QSCrempli" value=3 <?php if ($donnes['QSCrempli']==3){?> checked <?php }?>/> En attente OK qualité					</p>
					...
					<td>
					 ...
					 <input type="radio" name="FDA" value=1 
					...
					<td>
					 ...
					 <input type="radio" name="PVI" value=1 
					...
					<td>
					 ...
					 <input type="radio" name="FI" value=1 
...
<input type="radio" name="FI" value=3 <?php if ($donnes['FI']==3){?> checked <?php }?>/> En attente OK comptable					</p>
					...
					<td>
					 ...
					 <input type="date" name="DateFI" value="<?php if($donnes['DateFI']>'0000-00-01')
												...
												<tr>
												<td><label for="FI2">Seconde facture intermédiaire :</label></td>
					<td>
					
					 <input type="radio" name="FI2" value=1 
							<?php if ($donnes['FI2']==1){?> checked <?php }?>/> Oui
						<input type="radio" name="FI2" value=0 
					<?php if ($donnes['FI2']==0){?> checked <?php }?>/> Non 
<input type="radio" name="FI2" value=3 <?php if ($donnes['FI2']==3){?> checked <?php }?>/>En attente OK comptable</p>
					</select>
					</td>
					<td>
					
					 <input type="date" name="DateFI2" value="<?php if($donnes['DateFI2']>'0000-00-01')
												{ echo $donnes['DateFI2'];}
												?>"/>
					...
					<td>
					 ...
					 <input type="radio" name="Avenant" value=1 
					...
					<a href="supprimer.php?id=<?php echo $_GET['id'];?>" class="btn btn-danger">Supprimer l'étude</a>
				</form>
				</div>
				</div >
